...
- **Languages**: Java (OOP) (4+ years), Python, C, Scala, Bash, Processing
...
**Personal Project la-tastiera-ottima** — Real-time Typewriter-to-Keyboard  
...
2025
- Exports all iOS notes
- User-chosen directory
- Outputs to rtf format
...
- Focused on Functional and OOP paradigms, fixed bugs, and submitted multiple Pull Requests 

**Simple RSS chooser** [rss-moi](https://github.com/TrevCan/rss-moi)
- Fetches RSS feeds from files or text input URL 
- User selects articles to read and they open in Safari
...
- Developed autonomous routines, sensor integration, and robot control systems for the First Robotics Competition
...
2019 – 2025  
- Ran an Arch Linux home server (peak uptime 80+ days) with Lighttpd web server, cgit interface, git-over-HTTPS, dynamic DNS, port forwarding, and SSH VPN
- Hosted personal blog, website, and private repositories

**PISA Project** – High School Advanced Programming Final  
2022  
- Developed a full CRUD web application using XAMPP, PHP, MySQL, and JavaScript validation from scratch. 
- Collaborative project (2 developers)


**Additional Projects**  

- Visual Generation and Creative Coding. [creative-coding](https://github.com/trevcan/creative-coding)
...
**Creative Computacion**
[CENTRO de Diseño, Cine y Televisión](https://centro.edu.mx)
2026 - Present
...
**High School PrepaTec Multicultural** – Tec de Monterrey (ITESM)  
2019 – 2022

;tags: cv linux java c python in-control
